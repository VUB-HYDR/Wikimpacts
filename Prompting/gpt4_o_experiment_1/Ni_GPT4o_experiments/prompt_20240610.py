...
for item in dev_json: 
    ...
    Whole_text=''
    if Source != "https://en.wikipedia.org/wiki/2022_Dallas_floods": # multi event article, just notice to correctly handle this 
    ...
    prompt_list= [prompt_main_event_0610,prompt_perils_0610,prompt_location_0610, prompt_time_0610, 
                prompt_death_country_0610,prompt_non_fatal_injury_country_0610, prompt_displacement_country_0610,  prompt_homelessness_country_0610,
                prompt_affected_country_0610, prompt_insure_per_country_0610, prompt_total_damage_per_country_0610, prompt_building_damage_country_0610
               ]
    event_info={"Event_ID":Event_ID, "Source":Source,"Event_Name":Event_Name}
  
    for prompt in prompt_list:
      answer_str = completion_4(prompt_death_country_4)  # This returns a JSON format
...
with open(Result_DIR+'response_wiki_GPT4o_20240610_dev_set.json', 'w') as json_file:# this output is general and robust, compare to only ask the all the information per location, this capture more information 
